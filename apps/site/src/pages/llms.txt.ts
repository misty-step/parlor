...
export async function GET() {
  ...
  const text = [
    ...
    "",
    "Parlor 0.1.0 is MIT-licensed and source-distributed. Packages are not published to npm. Follow the source-workspace installation guide; pin a source revision. The game owns its rules, scoring, authorization, private projections, and credential endpoint.",
    "",
    "## Start here",
    "",
